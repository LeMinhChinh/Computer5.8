                                ...
                                <div class="boxsp">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-right">
                                            <a href="{{ route('user.addCart',['id' => $pr['id'],'quant' => $pr['quantity']]) }}" style="color:red;text-decoration:none;padding-right:15px">
